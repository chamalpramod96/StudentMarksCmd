...
class Student{
	...
	Student(String stId,String stName,int pfMarks,int dbMarks){
		this.stId = stId;
		this.stName = stName;
...
class StudentMarks{
	public static Student[] studentsArray = new Student[0];
	...
	public static void stDetails() {
		System.out.println("\t-----------------------------------------------------------------------------------------");
		System.out.printf("\t|%51s %34s %1s%n", "ADD NEW STUDENT", "","|");
		System.out.println("\t-----------------------------------------------------------------------------------------");
		System.out.println();

		Student[] tempstudentsArray = new Student[studentsArray.length + 1];
		...
		Student tempStudent = new Student(stId, stName);
	...
	public static void stDetailsWithMarks() {
		...
		Student tempStudent = new Student(stId, stName, pfMarks, dbMarks);
	...
	public static void printRanks() {
		...
		L1: for (int i = 0; i < studentsArray.length; i++) {
			if (studentsArray[i].getTotalMarks() < 0) {
				...
				System.out.format("\t|%-8s |%-8s |%-27s |%12s |%11s |%-1s", (i + 1), studentsArray[i].getStId(),studentsArray[i].getStName(), studentsArray[i].getTotalMarks(), avg, "");
			}
			System.out.println();
		}
		System.out.println("\t+---------+---------+----------------------------+-------------+------------+");
	...
	public static void getBestPF() {
		...
		L1: for (int i = 0; i < studentsArray.length; i++) {
			if (studentsArray[i].getPfMarks() < 0) {
				...
				System.out.format("\t|%-15s |%-28s |%-13s |%-13s| %-1s", studentsArray[i].getStId(),studentsArray[i].getStName(), studentsArray[i].getPfMarks(), studentsArray[i].getDbMarks(),"");
			}
			System.out.println();
		}
		System.out.println("\t+----------------+-----------------------------+--------------+-------------+");
	...
	public static void getBestDB() {
		...
		L1: for (int i = 0; i < studentsArray.length; i++) {
			if (studentsArray[i].getPfMarks() < 0) {
				...
				System.out.format("\t|%-15s |%-28s |%-13s |%-13s| %-1s", studentsArray[i].getStId(),studentsArray[i].getStName(), studentsArray[i].getDbMarks(), studentsArray[i].getPfMarks(),"");
			}
			System.out.println();
		}
		System.out.println("\t+----------------+-----------------------------+--------------+-------------+");
